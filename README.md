...
# Change Log
* 新增 node 服务转发 api 请求
* 增加在线[访问地址](http://www.iamsuperman.cn/vue2.x-douban/dist/#/)，node 服务转发 api 请求部署到 heroku
# 运行项目
...
//启动成功后，将看到输出
// HTTP Server is running in http://127.0.0.1:3000
```

最后打开浏览器，输入`localhost:8080`即可访问。效果图如下：
